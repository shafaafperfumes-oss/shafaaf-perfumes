...
var ShafaafIcons = {
  ...
  bottle: '<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5"><path d="M10 6h4v3.5c1.8.9 3 2.6 3 4.7V19a2 2 0 01-2 2H9a2 2 0 01-2-2v-4.8c0-2.1 1.2-3.8 3-4.7V6z" stroke-linejoin="round"/><path d="M10.5 3h3M12 3v3" stroke-linecap="round"/><path d="M14 4.5h3l1.5 1.5" stroke-linecap="round" stroke-linejoin="round"/></svg>',
  drop: '<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5"><path d="M12 3s6.5 7 6.5 11.5a6.5 6.5 0 01-13 0C5.5 10 12 3 12 3z" stroke-linejoin="round"/><path d="M9 14.5a3 3 0 002.2 3" stroke-linecap="round"/></svg>',
  incense: '<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5"><path d="M5 14h14l-1.6 5.2a1.5 1.5 0 01-1.4 1H8a1.5 1.5 0 01-1.4-1L5 14z" stroke-linejoin="round"/><path d="M4 14h16" stroke-linecap="round"/><path d="M9.5 10.5c-1.5-1.6 1.5-2.6 0-4.5M14.5 10.5c-1.5-1.6 1.5-2.6 0-4.5M12 8c-1.5-1.6 1.5-2.6 0-4.5" stroke-linecap="round"/></svg>',
